...
public class GameAIFrm extends javax.swing.JFrame {
    ...
    public GameAIFrm() {
        ...
        snakeGame = new SnakeGameAI(gameBoardPanel.getWidth(),gameBoardPanel.getHeight());
...
//GEN-FIRST:event_newGameMenuItemActionPerformed
            SnakeGameAI snake = new SnakeGameAI(600,600);
...
class SnakeGameAI extends JPanel implements ActionListener, KeyListener {
    private class Tile {
        int x;
        int y;
    ...
    SnakeGameAI(int boardWidth, int boardHeight) {
    ...
    public void move() {
        ...
        if (snakeHead.x*tileSize < 0 || snakeHead.x*tileSize > boardWidth - tileSize|| //passed left border or right border
            snakeHead.y*tileSize < 0 || snakeHead.y*tileSize > boardHeight - tileSize) { //passed top border or bottom border
            gameOver = true;
        }
    }
