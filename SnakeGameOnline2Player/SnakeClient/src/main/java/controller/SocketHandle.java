            ...
            while (true) {
                ...
                if (messageSplit[0].equals("go-to-room")) {
                    ...
                    Client.openView(Client.View.GAME_CLIENT
                            ...
                            , isStart
                            , competitorIP);
//                    Client.socketHandle.write("setup-player");
// Viết code o day
                }
                ...
                //Xử lý khi rắn ăn đc mồi, sinh ra mồi mới
                if (messageSplit[0].equals("food")){
                        Client.gameClientFrm.snakeGame.spawnFood1(messageSplit[1], messageSplit[2]);
                }
                
                //Xử lý khi rắn di chuyển
                if (messageSplit[0].equals("snake-move")){
                    Client.gameClientFrm.snakeGame.competitorSnake.moveCpt1(Integer.parseInt(messageSplit[1]), Integer.parseInt(messageSplit[2]), Integer.parseInt(messageSplit[3]));
                }
